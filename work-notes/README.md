...
### Linux
 ...
 - [systemd作者博客](./other/systemd_blog.md)
 - [CentOS6和CentOS7对比](./linux/centos6_centos7_diff.md)
 - [freedesktop.org对systemd的wiki](./other/systemd_wiki.md)
 - [安装genymotion模拟器](./other/genymotion_install.md)
 - [升级win10周年导致双系统grub挂掉](./other/win10_grub.md)
 - [如何优雅地使用win10的Linux子系统](./other/wsl.md)
 - [Debian镜像站点的目录结构](./other/debian_mirror.md)
 - [虚拟机安装debian失败：安装系统](./other/debian_vm.md)
 - [关于debian发布周期和各库的作用](./other/debian_apt_source.md)
 - [在dell XPS13(9350)上安装ubuntu15](./other/install_ubuntu_on_xps13.md)
...
### C
 ...
 - [c语言qsort()函数](./clang/c_qsort.md)
 - [c语言的一些关键字](./clang/c_keyword.md)
 - [C语言内存模型相关](./clang/c_mem_model.md)
 - [C语言指针与数组名](./clang/c_pointer_array.md)
 - [C语言数组名作为函数参数](./clang/c_array_func.md)
 - [arguments 和parameter的区别](./clang/arguments_parameter_diff.md)
